    ...
    <div className="bg-white">
      <div className="mx-auto max-w-2xl py-2 px-4 sm:px-6 lg:max-w-7xl lg:px-4">
        <div className="mt-6 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
          {products.data.map((datas) => (
            <div key={datas.id} className="group relative p-5 shadow-lg transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 ...">
              ...
              <h2 className='text-center'> {datas.attributes.name} </h2>
                    ...
                    <div className="relative w-auto my-6 mx-auto max-w-7xl">
                      <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                        ...
                        <div className="relative p-6">
                          {/* <ReactMarkdown children={datas.attributes.content} remarkPlugins={[remarkGfm]}/> */}
                          {/* <div dangerouslySetInnerHTML={{ __html: datas.attributes.content }}></div> */}
                          <div>
