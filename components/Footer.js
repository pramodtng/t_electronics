  ...
  return (
    <footer aria-label="Site Footer" className="bg-gray-50">
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <div className="mt-8 flex gap-6 text-gray-500">
              <a className="hover:opacity-75" href="https://www.facebook.com/Samsung-Bhutan-109897853812657/" target="_blank" rel="noreferrer">
        ...
        <p className="mt-8 text-xs text-gray-500">&copy; 2022 Tashi Electronics</p>
      </div>
    </footer>
