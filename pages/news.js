...
const news = () => {
  return (
    <section className="pt-5 pb-10 lg:pt-[10px] lg:pb-20">
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div className="mx-auto mb-10 max-w-[370px]">
              ...
              <div>
                <span
                  className="bg-primary mb-5 inline-block rounded py-1 px-4 text-center text-xs font-semibold leading-loose text-black"
                >
                  Dec 22, 2023
                </span>
                <h3>
